...
<img src="figuresProject/FirstStage/VerificacaoPasta.png" alt="Exemplo da verificação do diretório destino." title="Figura 1: Exemplo da verificação do diretório destino." width="800">

- **Passo 2:** Importar o arquivo .OVA.
<p>Figura 2: Importando Appliance contendo o arquivo .OVA.</p>
<img src="figuresProject/FirstStage/ImportarAppliance.jpg" alt="Importando Appliance contendo o arquivo .OVA." title="Figura 2: Importando Appliance contendo o arquivo .OVA." width="800">
...
<img src="figuresProject/FirstStage/ConfiguracoesAppliance.jpg" alt="Nomenclatura e destinação das Máquinas Virtuais." title="Figura 3: Nomenclatura e destinação das Máquinas Virtuais." width="800">
...
<p>Figura 4: Configuração de Rede da Máquina Virtual.</p>
<img src="figuresProject/FirstStage/RedeInternaAppliance.jpg" alt="Configuração de Rede da Máquina Virtual." title="Figura 4: Configuração de Rede da Máquina Virtual." width="800">

- **Passo 6:** Execução das oito máquinas virtuais e realização do login com o usuário ```administrador``` e com a senha ```adminifal```.

<p>Figura 5: Login na Máquina Virtual.</p>
<img src="figuresProject/FirstStage/LoginVM.jpg" alt="Login na Máquina Virtual." title="Figura 5: Login na Máquina Virtual." width="800">
...
<p>Figura 6: Configurações das Máquinas Virtuais da Bianca.</p>
<img src="figuresProject/FirstStage/ConfiguracaoVM-Bianca.png" alt="Configurações das Máquinas Virtuais da Bianca." title="Figura 6: Configurações das Máquinas Virtuais da Bianca." width="800">

<p>Figura 7: Configurações das Máquinas Virtuais do Pedro Henrique.</p>
<img src="figuresProject/FirstStage/ConfiguracaoVM-PedroH.png" alt="Configurações das Máquinas Virtuais do Pedro Henrique" title="Figura 7: Configurações das Máquinas Virtuais do Pedro Henrique" width="800">

<p>Figura 8: Configurações das Máquinas Virtuais do Pedro Vinícius.</p>
<img src="" alt="" title="" width="800">

<p>Figura 9: Configurações das Máquinas Virtuais da Thayná.</p>
<img src="figuresProject/FirstStage/ConfiguracaoVM-Thayna.png" alt="Configurações das Máquinas Virtuais da Thayná." title="Figura 9: Configurações das Máquinas Virtuais da Thayná." width="800">
...
<p>Figura 10: Exemplo de aplicação do comando da configuração de interface na VM01-PC01-BiancaL e VM02-PC01-BiancaL.</p>
<img src="figuresProject/FirstStage/Rede-Bianca.jpg" alt="Exemplo de aplicação do comando da configuração de interface na VM01-PC01-BiancaL e VM02-PC01-BiancaL." title="Figura 10: Exemplo de aplicação do comando da configuração de interface na VM01-PC01-BiancaL e VM02-PC01-BiancaL." width="800">
